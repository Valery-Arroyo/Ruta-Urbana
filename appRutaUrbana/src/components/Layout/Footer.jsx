      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            >
              <CodeOutlinedIcon sx={{ color: "#ff7a00", fontSize: 22 }} />
              <Typography
                variant="body2"
                sx={{ color: "#ff7a00", fontWeight: 600, letterSpacing: 1 }}
              >
                DESARROLLADORES
              </Typography>
            </Box>
            ...
            >
              <SchoolOutlinedIcon sx={{ color: "#ff7a00", fontSize: 18 }} />
              <Typography variant="body2" color="grey.500">
        ...
        <Divider sx={{ bgcolor: "#3b3b3b", mt: 3, mb: 2 }} />
