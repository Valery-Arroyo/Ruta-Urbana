...
-- ==========================================
INSERT INTO
    Producto (Nombre, Descripcion, Precio, Activo, IdCategoria)
VALUES
    -- Entradas
    (
        'Papas Ruta',
        'Papas fritas crujientes con sal gruesa y salsa especial Ruta',
        2500.00,
        1,
        1
    ), -- ID 1
    (
        'Papas a la Grandeza',
        'Papas fritas jumbo crujientes con sal gruesa y salsa especial Urbana',
        3000.00,
        1,
        1
    ), -- ID 2
    (
        'Aros de Cebolla',
        'Aros de cebolla empanizados y fritos con salsa BBQ',
        2800.00,
        1,
        1
    ), -- ID 3
    (
        'Bocaditos de Pollo',
        'Trozos de pollo empanizados con salsa a elección',
        3000.00,
        1,
        1
    ), -- ID 4
    ...
    (
        'La Bestia',
        'Mega hamburguesa con 4 tortas de carne, huevo frito, jalapeños, cebolla crujiente, lechuga, tomate y abundante queso cheddar',
        14500.00,
        1,
        2
    ), -- ID 5
    (
        'Ruta Clásica',
        'Carne de res 150g, lechuga, tomate, queso cheddar y salsa especial en pan brioche',
        6500.00,
        1,
        2
    ), -- ID 6
    (
        'La Doble Ruta',
        'Doble carne de res 200g, doble queso cheddar, tocino y salsa BBQ',
        9500.00,
        1,
        2
    ), -- ID 7
    (
        'Pollo Crujiente',
        'Pechuga de pollo crujiente, lechuga, tomate, pepinillo y mayonesa',
        7000.00,
        1,
        2
    ), -- ID 8
    (
        'La Barbacoa Especial',
        'Carne de res 200g, tocino, cebolla caramelizada, queso suizo y salsa BBQ',
        8500.00,
        1,
        2
    ), -- ID 9
    (
        'Ruta Picante',
        'Carne de res 150g, jalapeño, queso cheddar, cebolla fresca y salsa especial',
        7500.00,
        1,
        2
    ), -- ID 10
    (
        'La Aguacate',
        'Carne de res 200g, aguacate, tocino, queso suizo y mayonesa en pan brioche',
        9000.00,
        1,
        2
    ), -- ID 11
    ...
    (
        ...
        'Bizcocho caliente de chocolate con helado de vainilla',
        3500.00,
        1,
        3
    ), -- ID 12
    (
        'Helado de Oreo',
        'Copa de helado de vainilla con trozos de Oreo y salsa de chocolate',
        3000.00,
        1,
        3
    ), -- ID 13
    (
        'Batido de Fresa',
        'Batido espeso de fresa con leche y azúcar',
        3200.00,
        1,
        3
    ), -- ID 14
    ...
    (
        'Refresco Natural',
        'Refresco del día preparado con frutas naturales',
        1500.00,
        1,
        4
    ), -- ID 15
    (
        'Limonada',
        'Limonada frozen con hielo granizado y menta',
        2000.00,
        1,
        4
    ), -- ID 16
...
-- ==========================================
INSERT INTO
    ProductoIngrediente (IdProducto, IdIngrediente)
VALUES
    -- Papas Ruta (1)
    (1, 21),
    (1, 17),
    ...
    (14, 46),
    (14, 26),
    (14, 27), -- Fresa, Leche, Azúcar
    -- Refresco Natural (15)
    (15, 45),
    (15, 43),
    (15, 27), -- Fruta, Hielo, Azúcar
    -- Limonada (16)
    (16, 42),
    (16, 43),
    (16, 44),
    (16, 27), -- Limón, Hielo, Menta, Azúcar
    -- Café Americano (17)
    (17, 40),
    (17, 41);

-- Café molido, Agua caliente
-- ==========================================
-- IMÁGENES DE PRODUCTOS
-- ==========================================
INSERT INTO
    ProductoImagen (Imagen, EsPrincipal, IdProducto)
VALUES
    ('uploads/ImagenesRutaUrbana/papas-ruta.jpg', 1, 1),
    (
        'uploads/ImagenesRutaUrbana/papas-grandeza.jpg',
        1,
        2
    ),
    (
        'uploads/ImagenesRutaUrbana/aros-cebolla.png',
        1,
        3
    ),
    (
        'uploads/ImagenesRutaUrbana/nuggets-pollo.png',
        1,
        4
    ),
    (
        'uploads/ImagenesRutaUrbana/ham-la-bestia.png',
        1,
        5
    ),
    (
        'uploads/ImagenesRutaUrbana/ham-clasica.png',
        1,
        6
    ),
    (
        'uploads/ImagenesRutaUrbana/ham-doble-ruta.png',
        1,
        7
    ),
    (
        'uploads/ImagenesRutaUrbana/pollo-crujiente.png',
        1,
        8
    ),
    (
        'uploads/ImagenesRutaUrbana/ham-bbq-especial.png',
        1,
        9
    ),
    (
        'uploads/ImagenesRutaUrbana/ham-picante.png',
        1,
        10
    ),
    (
        'uploads/ImagenesRutaUrbana/ham-la-aguacate.png',
        1,
        11
    ),
    (
        'uploads/ImagenesRutaUrbana/brownie-chocolate.png',
        1,
        12
    ),
    (
        'uploads/ImagenesRutaUrbana/helado-oreo.png',
        1,
        13
    ),
    (
        'uploads/ImagenesRutaUrbana/batido-fresa.png',
        1,
        14
    ),
    (
        'uploads/ImagenesRutaUrbana/refresco-natural.png',
        1,
        15
    ),
    (
        'uploads/ImagenesRutaUrbana/limonada-frozen.png',
        1,
        16
    ),
    (
        'uploads/ImagenesRutaUrbana/cafe-americano.jpg',
        1,
        17
    );
...
VALUES
    (
        'Combo Clásico',
        'El sabor tradicional con papas crujientes y refresco natural.',
        9500.00,
        1,
        7,
        'uploads/ImagenesRutaUrbana/combo-clasico.png'
    ),
    (
        'Combo Doble',
        'Doble hamburguesa para los más hambrientos, con papas y limonada frozen.',
        12500.00,
        1,
        7,
        'uploads/ImagenesRutaUrbana/combo-doble.png'
    ),
    (
        'Combo Pollo',
        'Pollo crujiente acompañado de aros de cebolla y refresco natural.',
        10000.00,
        1,
        7,
        'uploads/ImagenesRutaUrbana/combo-pollo.png'
    ),
    (
        'Combo Postre',
        'Un dulce final: brownie de chocolate con café americano.',
        4200.00,
        1,
        9,
        'uploads/ImagenesRutaUrbana/combo-postre.png'
    ),
    (
        'Combo Barbacoa',
        'Perfecto para compartir: hamburguesas BBQ, aguacate fresco, papas y limonadas.',
        28000.00,
        1,
        6,
        'uploads/ImagenesRutaUrbana/combo-bbq-familiar.png'
    ),
    (
        'Combo Goloso',
        'Para los amantes del dulce: hamburguesa clásica, papas y brownie de chocolate.',
        11500.00,
        1,
        9,
        'uploads/ImagenesRutaUrbana/combo-goloso.png'
    );
...
-- ==========================================
INSERT INTO
    ComboProducto (IdCombo, IdProducto, Cantidad)
VALUES
    -- Combo Clásico (1)
    (1, 6, 1),
    (1, 1, 1),
...
-- ==========================================
INSERT INTO
    Menu (Nombre, HoraInicio, HoraFin, EstaActivo)
VALUES
...
-- ==========================================
INSERT INTO
    MenuDisponibilidad (IdMenu, FechaInicio, FechaFin, DiaSemana)
VALUES
    (1, NULL, NULL, 'Lunes'),
    (1, NULL, NULL, 'Martes'),
...
-- ==========================================
INSERT INTO
    MenuItem (IdMenu, IdProducto, IdCombo)
VALUES
    -- Menú Mediodía (1)
...
VALUES
    (
        'Parrilla',
        'Cocción de carnes y proteínas a la parrilla'
    ), -- ID 1
    (
        'Freidora',
        'Fritura de papas, aros, nuggets y otros empanizados'
    ), -- ID 2
    (
        'Ensamble',
        'Armado y presentación final de la hamburguesa'
    ), -- ID 3
...
VALUES
    (
        ...
        'admin@rutaurbana.com',
        '$2y$10$TkD/2cCz3vlQz3CCsds8y.4MkaSEnNHSXIUOi1KSjNMFwxWX.3RAK',
        NULL,
        1,
        (
            SELECT
    ...
    (
        'Carlos Méndez',
        'carlos.mendez@rutaurbana.com',
        '$2y$10$dM8OwRR.oHvZz7cwpGnE0OYuqC35DaO7ioBBzj8kzYvXyu//W.7hy',
        NULL,
        1,
        (
            SELECT
    ...
    (
        'Fernanda Solano',
        'fernanda.solano@gmail.com',
        '$2y$10$Q6QQr.p4yW2WuIt9chf4l.XheHVqx05CHH3tpItMtGuHuyzuVn1zu',
        'San José, Costa Rica',
        1,
        (
            SELECT
    ...
    (
        ...
        (
            ...
            FROM
                Usuario
            WHERE
                Correo = 'fernanda.solano@gmail.com'
        ),
        NULL,
        (
            SELECT
    ...
    (
        ...
        (
            ...
            FROM
                Usuario
            WHERE
                Correo = 'carlos.mendez@rutaurbana.com'
        ),
        (
            SELECT
                IdMetodoEntrega
...
VALUES
    ...
    (
        ...
        'Pago recibido y pedido entregado'
    ),
    (
        (
            SELECT
    ...
    (
        ...
        'Pago recibido, pedido en proceso'
    ),
    (
        (
            SELECT
...
VALUES
    (
        'Cocina',
        'cocina@rutaurbana.com',
        '$2y$10$rGHakxaHIV/A.ove115/9OO/gBCNdC2m2GG/0LuopVXkjeG1vIlgC',
        NULL,
        1,
        (
            SELECT
